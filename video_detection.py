...
def process_video_file(video_path):
    ...
    # Set a slower frame display rate for better visualization
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", "-m", type=str, choices=["live", "video"], default="live",
                        help="Input mode: 'live' for camera or 'video' for video file processing")
